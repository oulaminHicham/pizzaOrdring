...
reducers:{
    addItme(state , action){
        // payload shold be new item {}
        state.cart.push(action.payload);
    },
    deleteItem(state , action){
        //payload will be id of item
...
export const {addItme , deleteItem , increaseItemQuantity , decreaseItemQuantity , clearCart}=cartSlice.actions;
